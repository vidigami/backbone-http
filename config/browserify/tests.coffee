...
module.exports =
  underscore:
    ...
    options:
      ...
      shim:
        'backbone-http': {path: './backbone-http.js', exports: 'BackboneHTTP', depends: {jquery: 'jQuery', underscore: '_', backbone: 'Backbone', moment: 'moment', 'backbone-orm': 'BackboneORM', stream: 'stream'}}
